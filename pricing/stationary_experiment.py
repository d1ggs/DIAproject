...
pricess = [[4,3,2,1,5,6],[40,30,20,10,50,60],[400,300,200,100,500,600],[4000,3000,2000,1000,5000,6000]]
#pricess = [[63, 76, 10, 8, 53, 21],[8,10,21,53,63,76],[10,53,76,63,21,8],[76,63,53,21,10,8]]
T = 100
arms = [0, 1, 2, 3, 4, 5]
n_arms = len(arms)
n_experiments = 50
