...
if __name__ == "__main__":
    ...
    budget_allocator = StatelessBudgetAllocation(TOTAL_BUDGET, monte_carlo_simulations, n_steps_max)
    ...
    for _ in trange(N_EXPERIMENTS):
        ...
        for _ in range(TIME_HORIZON):
            ...
            #TODO add LinUCB Learner matrices
            budget, _, seeds = budget_allocator.joint_influence_maximization(social_networks[0].get_matrix(), social_networks[1].get_matrix(), social_networks[2].get_matrix(), weights=weights)
